...
1. Search the term `machine learning`

2. Find the document `Deep Learning vs. Machine Learning: What's the Difference? - Lucidworks` 

3. Hover your mouse over the document and updated the **Position** text to `1` to ensure it occupies that spot  
...
1. Search `California Data Processing Agreement`

2. Hover your mouse over the document 
...
1. Search `New Survey: State of user Service 2021 - Lucidworks`
...
1. Search `Smart Answers`

2. Hover your mouse over **How to Use Smart Answers for Product Discovery**  
...
3. Click **+ New** in the Zones section. 
</details>
<br>
...
1. Enter `Trending Articles` as the DISPLAY NAME

2. Ensure that `Result-List` is selected as the TYPE

3. Click the QUERY PROFILE drop down list and select **sitesearch2** as the associated query profile

4. Click **Next Step** to move to Step 2
</details>
<br>

5. In order to make this zone stand out from the main results list, you decide to have the results displayed as list of articles. Additionally, You want your display fields to have the article nameX_s, descripion, and image on each grid tile. How will you configure this?
...
1. Ensure that `list` is selected as the RESULTS LAYOUT

2. Enter `nameX_s` in the Field Name for the Title Field Display

3. Enter `image` in the Field Name for the Image Field Display

4. Enter `description` in the Field Name for the Description Field Display

5. Click **Save** in the New Zone window.
</details>
<br>
...
1. Click the **Optimizer** icon see the template in action. 
...
3. Click **Publish**, then click **Confirm and Publish**
...
1. Search `data analytics` and click the **blue plus icon** to add a rewrite. If you don't immediately see the icon, hover your mouse over the search box.  

2. From the list of search rewrite options, select **Synonym**  

3. Choose the direction of **symmetric**  

4. Enter `data science` in the Synonym Mappings field  
...
1. Search `Fusoin` (the incorrect term) and click the **blue plus icon** to add a rewrite. If you don't immediately see the icon, hover your mouse over the search box.     

2. From the list of search rewrite options, select **Misspelling**  

3. Enter `Fusion` in the Corrected Term field  
...
1. Search `artificial intelligence` and click the **blue plus icon** to add a rewrite. If you don't immediately see the icon, hover your mouse over the search box.    
...
1. Search `AI powered search initiatives` and click the **blue plus icon** to add a rewrite. If you don't immediately see the icon, hover your mouse over the search box.    

2. From the list of search rewrite options, select **Head/Tail**  

3. Enter `AI powered search` in the Improved Query field  
...
3. Enter in `smartanswers` in the Misspelling  

4. Enter `smart answers` as the suggested Correction  

5. Click **enter/return** on your keyboard  

6. Click the **check** to save this rewrite to your list
...
1. Hover your mosue over the rule **Gartner Pinned Items**

2. Click **the pencil edit icon**  

3. Click the **+ ADD** button next to the PINNED DOCUMENTS section 

4. Enter `https://lucidworks.com/ebooks/gartner-critical-capabilities-for-insight-engines/`as the VALUE

5. Enter `1` as the POSITION

6. Click the **Save** to save the updates to the rule
